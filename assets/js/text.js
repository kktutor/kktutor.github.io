...
let i = 0,
    timer = 0,    
	str = '<h4>\xa0\xa0\xa0\xa0\xa0\xa0\xa0&#128151"功法目录"&#128151</h4><br/>1.战神引擎零基础视频教程.<br/>2.雷霆传奇视频教程.<br/>3.传奇地图由浅入深制作视频教程.<br/>4.UE4系列各个板块教程.<br/>5.游戏破解系列......<br/>\xa0\xa0\xa0\xa0\xa0\xa0\xa0&#128525&#128525↓↓↓更多点击↓↓↓&#128525&#128525' 
function typing() {
    if (i <= str.length) {
...
var binft = function (r) {
    ...
    var l = "",
        o = ["大道三千,我有我缘","经书万卷,不如一起来看",].map(function (r) {
            return r + "."
        }),
        a = 2,
        g = 1,
